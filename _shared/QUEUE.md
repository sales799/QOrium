...
| Reverify active-origin runtime | DONE | Active origin checkout is `a929cb1ee69a8c172b1fb181da4c3222290f2843` on `codex/saml-live-active-origin-20260602`; PM2 marketing/chatbot are online from `current` with unstable restarts `0`. | Re-run after next deploy. |
