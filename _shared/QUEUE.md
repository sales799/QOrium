...
| QOrium Phase 1 / marketing release proof | DONE | Active-origin `/opt/apps/qorium-marketing` is on `codex/qorium-programmatic-seo-factory-phase1` at `18110f1`; public `/` and `/healthz` returned HTTP `200` at `2026-06-02T08:51:45Z`; security headers present. | Keep current active-origin release. |
