...
- Active production origin is `qorium-active-origin` (`187.127.155.150`) at `18110f1f5653` on `codex/qorium-programmatic-seo-factory-phase1`.
...
- Active-origin gates passed:
  ...
  - `pnpm secrets:scan` (`162` commits scanned; no leaks)
