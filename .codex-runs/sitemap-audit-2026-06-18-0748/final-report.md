...
Status: in progress. Local remediation and quality gates are complete; commit, deploy, and live verification are pending.
...
- Regression tests added for representative sitemap template families.
- Local gates passed: marketing typecheck, marketing lint, marketing build, targeted Playwright, root typecheck, root tests, root lint, gitleaks, high-threshold production audit, and root build.
