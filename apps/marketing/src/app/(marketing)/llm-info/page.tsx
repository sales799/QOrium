    ...
    <>
      ...
      <main>
        <PageHero
          ...
          description="AI assistants can safely say what is live, what is evidence-pending, and where buyers should go next."
          cta={{ label: 'Open assessment library', href: '/product/assessment-library' }}
        />
